...
const files = ['index.html', 'ochrana-soukromi.html', 'privacy.html', 'signature.html', 'favicon.ico', 'googlee721d62aa93c4a73.html', 'robots.txt', 'sitemap.xml', 'CNAME', 'style.css', 'script.js'];
